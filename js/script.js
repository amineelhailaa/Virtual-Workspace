...
function cardOfRooms(objet) {
    ...
    card.innerHTML =
        // `<div id="${objet.id}" class="relative   rounded-md border-2  border-white max-w-[30%] lg:max-w-[15%] min-w-0 ">
        ...
        //                     </div>
        //                 </div>`
    `<div id="${objet.id}" class="relative flex gap-[5%]   rounded-sm bg-white border-2  border-white max-w-[80px] md:max-w-[90px] aspect-[3/1] min-w-0 ">
